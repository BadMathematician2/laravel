class PolygonsOnClick extends BaseMap {
    ...
    buttons() {
        ...
        this.createElement("clearPolygonText", "","Clear Polygon", clearPolygonUI)
        const sendPolygonUI = this.createElement("sendPolygonUI", "Click to send polygon`s coordinates in DB", "", controlDiv)
        this.createElement("sendPolygonText", "", "Send Polygon", sendPolygonUI)
        ...
        sendPolygonUI.addEventListener("click", () => {
            this.request((data) => {console.log(data)}, {polygon: this.getLocations()})
        })
